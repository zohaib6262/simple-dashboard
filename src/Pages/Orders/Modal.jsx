    ...
    <dialog ref={modal} className="result-modal" onClose={close}>
      {open && (
        <div
          ...
          id="my-modal"
        >
          <div className="relative top-44 h-64 my-auto mx-auto p-3 border w-1/2 shadow-lg rounded-md bg-white">
            <div className="mt-3 text-center">
              ...
              <div className="flex justify-center gap-8 mt-5  items-center px-4 py-3">
                <button
                  ...
                  className="px-4 py-2 bg-[#FF6666] text-white text-base font-medium rounded-md w-1/3 shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-400"
                >
                  Download PDF
                </button>
                <button
                  ...
                  className="px-4 py-2 bg-[#54C48D] text-white text-base font-medium rounded-md w-1/3 shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-400"
                >
                  Download CSV
                </button>
              </div>
