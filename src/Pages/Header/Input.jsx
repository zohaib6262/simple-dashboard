  ...
  return (
    <>
      <form className="flex sm:flex-row border-2 border-hidden rounded-lg overflow-visible w-80 bg-[#EDF8FD]">
        ...
        />
        <div className="m-auto relative lg:left-5 sm:-left-4 text-white bg-[#008ECC] focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-3 py-1 search-icon-container">
